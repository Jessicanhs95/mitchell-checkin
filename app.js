...
function sendSlack(section,title,field,value){
  ...
  fetch(WH,{method:'POST',mode:'no-cors',headers:{'Content-Type':'text/plain'},body:JSON.stringify({text})}).catch(()=>{});
}
let html='',sec='';
ITEMS.forEach((it,i)=>{
